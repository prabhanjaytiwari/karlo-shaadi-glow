    ...
    <section className="relative py-20 md:py-32 px-4 sm:px-6 text-center overflow-hidden"
      ...
      <div className="relative z-10 max-w-[560px] mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <p className="text-[0.7rem] font-semibold tracking-[0.2em] uppercase mb-4" style={{ color: "#E8B94A" }}>
            Ab Decision Lena Hai
          </p>
          <h2 className="font-display font-bold text-white leading-[1.1] text-2xl md:text-5xl">
            Aapke Competitors<br />
            Already <span className="italic" style={{ color: "#E8B94A" }}>Register</span> Kar Chuke Hain
          </h2>
          <p className="text-white/55 text-sm md:text-base mt-4 mb-3 leading-relaxed">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8"
            ...
            <span className="text-[0.65rem] font-medium" style={{ color: "#E8B94A" }}>
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          <button onClick={() => navigate("/vendor/onboarding")}
            className="px-7 md:px-10 py-3.5 md:py-4 rounded-xl font-bold text-sm md:text-base cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(201,150,42,0.5)]"
          ...
          <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer"
            className="px-5 md:px-8 py-3.5 md:py-4 rounded-xl text-sm text-white/90 cursor-pointer transition-all duration-300 hover:bg-white/[0.08] inline-flex items-center gap-2 backdrop-blur-sm"
            style={{ border: "1px solid rgba(255,255,255,0.25)" }}>
            💬 Chat on WhatsApp
          </a>
        </div>

        <p className="text-[0.6rem] text-white/30 mt-5">

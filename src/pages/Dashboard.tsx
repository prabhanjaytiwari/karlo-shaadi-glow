          ...
          <div className="grid grid-cols-4 lg:grid-cols-8 gap-1.5 sm:gap-4 mb-4 sm:mb-12 animate-fade-up">
            <Card className="bg-white/80 border border-accent/20 hover:border-accent/40 hover:shadow-lg transition-all cursor-pointer active:scale-95" onClick={() => navigate("/search")}>
              <CardHeader className="p-3 sm:p-4">
                ...
                <CardTitle className="text-[11px] sm:text-sm">Search</CardTitle>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/80 border border-accent/20 hover:border-accent/40 hover:shadow-lg transition-all cursor-pointer active:scale-95" onClick={() => navigate("/bookings")}>
              <CardHeader className="p-3 sm:p-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-accent/20 to-amber-200/50 flex items-center justify-center mb-1 sm:mb-2">
                  <Calendar className="h-4 w-4 sm:h-5 sm:w-5 text-accent" />
                </div>
                <CardTitle className="text-[11px] sm:text-sm">Bookings</CardTitle>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/80 border border-accent/20 hover:border-accent/40 hover:shadow-lg transition-all cursor-pointer active:scale-95" onClick={() => navigate("/favorites")}>
              <CardHeader className="p-3 sm:p-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-rose-200/50 to-pink-200/50 flex items-center justify-center mb-1 sm:mb-2">
                  <Heart className="h-4 w-4 sm:h-5 sm:w-5 text-rose-500" />
                </div>
                <CardTitle className="text-[11px] sm:text-sm">Favorites</CardTitle>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/80 border border-accent/20 hover:border-accent/40 hover:shadow-lg transition-all cursor-pointer active:scale-95" onClick={() => navigate("/messages")}>
              <CardHeader className="p-3 sm:p-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-accent/20 to-blue-200/50 flex items-center justify-center mb-1 sm:mb-2">
                  <MessageSquare className="h-4 w-4 sm:h-5 sm:w-5 text-accent" />
                </div>
                <CardTitle className="text-[11px] sm:text-sm">Messages</CardTitle>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/80 border border-accent/20 hover:border-accent/40 hover:shadow-lg transition-all cursor-pointer active:scale-95" onClick={() => navigate("/moodboards")}>
              <CardHeader className="p-3 sm:p-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-accent/20 to-purple-200/50 flex items-center justify-center mb-1 sm:mb-2">
                  <Palette className="h-4 w-4 sm:h-5 sm:w-5 text-accent" />
                </div>
                <CardTitle className="text-[11px] sm:text-sm">Moodboards</CardTitle>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/80 border border-accent/20 hover:border-accent/40 hover:shadow-lg transition-all cursor-pointer active:scale-95" onClick={() => navigate("/checklist")}>
              <CardHeader className="p-3 sm:p-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-emerald-200/50 to-teal-200/50 flex items-center justify-center mb-1 sm:mb-2">
                  <ListChecks className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-600" />
                </div>
                <CardTitle className="text-[11px] sm:text-sm">Checklist</CardTitle>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/80 border border-accent/20 hover:border-accent/40 hover:shadow-lg transition-all cursor-pointer active:scale-95" onClick={() => navigate("/budget")}>
              <CardHeader className="p-3 sm:p-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-accent/30 to-amber-200/50 flex items-center justify-center mb-1 sm:mb-2">
                  <PiggyBank className="h-4 w-4 sm:h-5 sm:w-5 text-accent" />
                </div>
                <CardTitle className="text-[11px] sm:text-sm">Budget</CardTitle>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/80 border border-accent/20 hover:border-accent/40 hover:shadow-lg transition-all cursor-pointer active:scale-95" onClick={() => navigate("/guest-list")}>
              <CardHeader className="p-3 sm:p-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-accent/20 to-rose-200/50 flex items-center justify-center mb-1 sm:mb-2">
                  <Users className="h-4 w-4 sm:h-5 sm:w-5 text-accent" />
                </div>
                <CardTitle className="text-[11px] sm:text-sm">Guests</CardTitle>
              </CardHeader>
            </Card>
          </div>

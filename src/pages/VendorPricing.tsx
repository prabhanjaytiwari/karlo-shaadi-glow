...
export default function VendorPricing() {
  ...
  const plans = [
    ...
    },
    {
      ...
      lossAversion: 'You lose ~₹15,000/month in bookings without Silver',
      spotsLeft: 23,
    },
    {
      id: 'gold',
      ...
      lossAversion: 'You lose ~₹40,000/month in leads without Gold',
      spotsLeft: 11,
    },
    {
      id: 'diamond',
      ...
      lossAversion: 'You lose ~₹1,00,000/month in revenue without Diamond',
      spotsLeft: 5,
    },
  ];
